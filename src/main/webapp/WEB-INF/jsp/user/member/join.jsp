		...
		<form action="../member/doJoin" method="POST">
			<table border="1" cellspacing="0" cellpadding="5" style="width: 100%; border-collapse: collapse;">
				<tbody>
					...
					<tr>
						<th>이름</th>
						<td style="text-align: center;"><input name="name" autocomplete="off" type="text" placeholder="이름를 입력해" /></td>

					</tr>
					<tr>
						<th>닉네임</th>
						<td style="text-align: center;"><input name="nickname" autocomplete="off" type="text" placeholder="닉네임를 입력해" /></td>

					</tr>
					<tr>
						<th>전화번호</th>
						<td style="text-align: center;"><input name="cellphoneNum" autocomplete="off" type="text" placeholder="전화번호를 입력해" /></td>
